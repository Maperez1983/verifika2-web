      ...
      <main className="flex-1">
        ...
        <div className="mx-auto grid w-full max-w-6xl gap-6 px-6 py-12 lg:grid-cols-3">
          ...
          <aside className="rounded-[28px] border border-[color:var(--border)] bg-[color:var(--surface)] p-6 shadow-sm">
            <p className="text-sm font-semibold tracking-tight">Seguimiento privado</p>
            <p className="pt-2 text-sm leading-6 text-slate-600">
              Cada propietario puede consultar la evolución de su inmueble con información ordenada, citas, actividad comercial y estado de la operación.
            </p>
            <p className="pt-5 text-xs leading-5 text-slate-600">
              Una experiencia pensada para que la venta se entienda sin llamadas innecesarias ni pérdida de contexto.
            </p>
          </aside>
        </div>
